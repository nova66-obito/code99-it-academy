...
import tol4 from "../assets/eclipse-seeklogo.png"
          ...
          <section className="overall">
             ...
             <div className="quest center">
                ...
                <div className="q-cover center">
                   <Quest txt={"what toos will learn to use full stact devloper"}/>
                   <Quest txt={"what toos will learn to use full stact devloper"}/>
                   <Quest txt={"what toos will learn to use full stact devloper"}/>
                   <Quest txt={"what toos will learn to use full stact devloper"}/>
                   <Quest txt={"what toos will learn to use full stact devloper"}/>
