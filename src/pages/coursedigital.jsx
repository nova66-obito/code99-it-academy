...
import tol1 from "../assets/dg1.png"
import tol2 from "../assets/dg2.png"
import tol3 from "../assets/dg3.jpeg"
import tol4 from "../assets/dg4.png"
          ...
          <section className="overall">
                 ...
                 <div className="sign-cover center">
                      <div className="s-text s-text1">
                          <div className="inner txt">
                            ...
                            <hr />
                            <small>get a IT courses and digital marketing in chennai at code99 academy for your next-level career</small>
                          </div>
             ...
             <div className="about-train center">
                 <div className="t-about">
                    ...
                    <p>⭐ Our digital marketing course equips you with the skills to create digital marketing and social media advertisment. You'll start with the basics, understanding the difference between digital marketing and offline marketing , and exploring the importance of logical thinking. Learn key principles for marketing , consistency, and accessibility, while using popular tools like canva and more.</p>
                    <p>⭐ Through hands-on exercises, you'll develop Digitalmarketing, prototypes, and interactive components. Dive deeper into user research, personas, user journeys, and usability testing to build intuitive designs and logical.</p>
                    <p>⭐ By the end of this course, you'll have the practical skills needed to digital market solutions, create logical prototypes, and showcase your advertisment. Whether you're new to the field or looking to upgrade your skills, this course prepares you to succeed in the ever-evolving world.</p>
                 </div>
             ...
             <div className="quest center">
                ...
                <div className="q-cover center">
                   <Quest txt={"what tools will learn to use digital marketing"}/>
                   <Quest txt={"what tools will learn to use digital marketing"}/>
                   <Quest txt={"what tools will learn to use digital marketing"}/>
                   <Quest txt={"what tools will learn to use digital marketing"}/>
                   <Quest txt={"what tools will learn to use digital marketing"}/>
